...
proc varimpute data=MYCASLIB.BIG_ORGANICS;
	...
	input DemGender DemReg DemTVReg PromClass / 
		ntech=mode;
...
proc varreduce data=MYCASLIB.BIG_ORGANICS_IMPUTED;
	class IM_DemGender IM_DemReg IM_DemTVReg 
		IM_PromClass;
	reduce supervised TargetBuy=IM_DemAffl IM_DemAge IM_PromSpend IM_PromTime 
		 IM_DemGender IM_DemReg IM_DemTVReg 
...
proc gradboost data=MYCASLIB.SAMPLED;
	...
	input  IM_DemGender IM_DemReg IM_DemTVReg 
	...
	score out=MYCASLIB.scored_gb copyvars=(TargetBuy IM_DemAffl IM_DemAge 
		IM_PromSpend IM_PromTime  IM_DemGender 
...
proc logselect data=MYCASLIB.SAMPLED;
	...
	class  IM_DemGender IM_DemReg IM_DemTVReg 
		IM_PromClass;
	model TargetBuy(event='1')= IM_DemGender 
...
/*Score Final Model*/
proc astore ;
	score data=MYCASLIB.BIG_ORGANICS_Imputed out=MYCASLIB.score rstore=MYCASLIB.SCORE;
run;

...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/* Columns processname and subgroupname partition the data for one control chart.*/
%delete_table(lib=public,ds=pchart_bsp2a_outlimits);
%delete_table(lib=public,ds=pchart_bsp2a_outtable);
...
%delete_table(lib=public,ds=DB2);
PROC FEDSQL sessref=mysess;
...
/* Columns processname and subgroupname partition the data for one control chart.*/
%delete_table(lib=public,ds=xschart_dashboard_outlimits);
%delete_table(lib=public,ds=xschart_dashboard_outtable);
